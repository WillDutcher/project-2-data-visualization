...
results = [die_1.roll() * die_2.roll() for _ in range(num_times)]
# for roll_num in range(1, num_times + 1):
#     result = die_1.roll() * die_2.roll()
#     results.append(result)
#
# test_results = [die_1.roll() * die_2.roll() for _ in range(num_times)]
# print(test_results)

# Analyze the results.
frequencies = []
max_result = die_1.num_sides * die_2.num_sides
frequencies = [results.count(num) for num in range(max_result)]
